...
public:
	...
	Punct_stream& operator>>(string& s);		//like when we declared the >> operator for other classes (where we used istream& instead), here
	operator bool();							//we declare the >> operator for punct_stream&
private:
