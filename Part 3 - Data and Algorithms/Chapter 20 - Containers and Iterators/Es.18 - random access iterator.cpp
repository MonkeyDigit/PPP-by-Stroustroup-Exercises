...
class my_vector<T>::iterator{
    ...
    T* last;
public:
	iterator(T* curr, T* first, T* last) : curr{curr}, first{first}, last{last} { }
...
template<class T>
typename my_vector<T>::iterator& my_vector<T>::iterator::operator++() // forward
{
...
template<class T>
typename my_vector<T>::iterator& my_vector<T>::iterator::operator--()// backward
{
