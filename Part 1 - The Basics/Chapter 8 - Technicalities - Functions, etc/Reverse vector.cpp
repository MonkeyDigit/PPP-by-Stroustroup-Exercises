...
void print(string s,vector<int>& v);	//Print the vector
void reverse_copy_vec(vector<int>& v);	//Create a reversed copy of the vector
void reverse_vec(vector<int>& v);		//Reverse the actual vector
...
void reverse_copy_vec(vector<int>& v)
{
	vector<int> vc;					//vector copy
