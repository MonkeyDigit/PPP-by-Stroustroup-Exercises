...
//Made Date a class instead of struct
class Date {
public:
	Date(int yy, int mm, int dd);  // check for valid date and initialize - won't compile if a class with a constructor is initialized without using it
